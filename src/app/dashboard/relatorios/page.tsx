...
export default function ReportPage() {
    ...
    const handleGenerateReport = async (format: 'pdf' | 'excel' | 'csv') => {
        ...
        try {
            ...
            // In a real app, this would handle the downloaded file
    ...
    return (
        <div className="p-1 sm:p-5 max-w-7xl mx-auto">
            ...
            {/* Main content - Split view when a report is selected */}
            ...
            ${selectedReport ? 'lg:col-span-6' : 'lg:col-span-12'}`}
                >
                    <h2 className="text-xl text-gray-800 font-semibold mb-4">Relatórios Disponíveis</h2>
                ...
                {selectedReport && (
                    <motion.div
                        ...
                        className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-4 sm:p-5 lg:col-span-6"
                    >
